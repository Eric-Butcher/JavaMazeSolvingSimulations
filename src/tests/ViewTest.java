...
public class ViewTest {
    ...
    public void testUpdateView_singleChange(){
        ...
        TileUpdate tileUpdateA = new TileUpdate(3, 11, false, true, true, false, false, true, false, false);
        ...
        TileUpdate tileUpdateB = new TileUpdate(3, 11, false, false, true, false, true, true, true, false);
    ...
    public void testUpdateView_multipleLines(){
        ...
        for (int i = 0; i < 10; i++){
            TileUpdate tileUpdate = new TileUpdate(i, 2, false, false, true, false, false, true, false, false);
        ...
        for (int i = Constants.minCellIndex; i <= Constants.maxCellIndex; i++){
            TileUpdate tileUpdate = new TileUpdate(12, i, true, true, false, false, false, false, true, true);
        ...
        for (int i = Constants.minCellIndex; i <= Constants.maxCellIndex; i++){
            TileUpdate tileUpdate = new TileUpdate(12, i, false, true, false, false, true, false, true, false);
